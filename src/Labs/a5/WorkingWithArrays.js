...
function WorkingWithArrays() {
    ...
    return (
        <div>
            ...
            <h3>Updating the description of of the todo item</h3>
            <a
            ...
            <input
                ...
                value={todo.description || todo.title}
                onChange={(e) => setTodo({
            ...
            <h3>Updating the completed property of of the todo item</h3>
            ...
            <div style={{ justifyContent: "center", display: "flex" }}>
                <textarea
                    ...
                    value={todo.description || todo.title} type="text"
                />
            </div>
            <div style={{ justifyContent: "center", display: "flex" }}>
                <input
